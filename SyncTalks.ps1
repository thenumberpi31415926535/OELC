...
function ExtractDateTimeFromString
{
    ...
    if([System.DateTimeOffset]::TryParseExact("$String +0800", 'MM/dd/yyyy H:mm:ss K', [System.Globalization.CultureInfo]:: InvariantCulture, [System.Globalization.DateTimeStyles]:: AssumeUniversal, [ref]$date))
    {
        return $date
    }
<#
